...
import static com.jetbrains.jsonSchema.internal.JsonSchemaVariantsTreeBuilder.andGroups;

public final class AllOfOperation extends Operation {
  private final JsonSchemaService myService;

  public AllOfOperation(@Nonnull JsonSchemaObject sourceNode, JsonSchemaService service, @Nullable JsonSchemaNodeExpansionRequest expansionRequest) {
