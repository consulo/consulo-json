...
public class LegacyJsonSchemaObjectMerger implements JsonSchemaObjectMerger {
    ...
    private static void mergeValues(@Nonnull JsonSchemaObjectImpl base, @Nonnull JsonSchemaObjectImpl other) {
        ...
        if (!StringUtil.isEmptyOrSpaces(other.getTitle())) {
            base.setTitle(other.getTitle());
        }
        if (!StringUtil.isEmptyOrSpaces(other.getDescription())) {
            base.setDescription(other.getDescription());
        }
        if (!StringUtil.isEmptyOrSpaces(other.getHtmlDescription())) {
            base.setHtmlDescription(other.getHtmlDescription());
        }
        if (!StringUtil.isEmptyOrSpaces(other.getDeprecationMessage())) {
            base.setDeprecationMessage(other.getDeprecationMessage());
        }
        ...
        if (other.myUniqueItems != null) {
            base.setUniqueItems(other.myUniqueItems);
        }
        ...
        if (other.myDefault != null) {
            base.setDefault(other.myDefault);
        }
        if (other.getExample() != null) {
            base.setExample(other.getExample());
        }
        if (other.getFormat() != null) {
            base.setFormat(other.getFormat());
        }
        if (other.getMultipleOf() != null) {
            base.setMultipleOf(other.getMultipleOf());
        }
        if (other.getMaximum() != null) {
            base.setMaximum(other.getMaximum());
        }
        if (other.getMinimum() != null) {
            base.setMinimum(other.getMinimum());
        }
        if (other.getExclusiveMaximumNumber() != null) {
            base.setExclusiveMaximumNumber(other.getExclusiveMaximumNumber());
        }
        if (other.getExclusiveMinimumNumber() != null) {
            base.setExclusiveMinimumNumber(other.getExclusiveMinimumNumber());
        }
        if (other.getMaxLength() != null) {
            base.setMaxLength(other.getMaxLength());
        }
        if (other.getMinLength() != null) {
            base.setMinLength(other.getMinLength());
        }
        if (other.myPattern != null) {
            base.myPattern = other.myPattern;
        }
        if (other.getAdditionalPropertiesSchema() != null) {
            base.setAdditionalPropertiesSchema(other.getAdditionalPropertiesSchema());
        }
        if (other.getPropertyNamesSchema() != null) {
            base.setPropertyNamesSchema(other.getPropertyNamesSchema());
        }
        if (other.myAdditionalItemsAllowed != null) {
            base.setAdditionalItemsAllowed(other.myAdditionalItemsAllowed);
        }
        if (other.getAdditionalItemsSchema() != null) {
            base.setAdditionalItemsSchema(other.getAdditionalItemsSchema());
        }
        if (other.getItemsSchema() != null) {
            base.setItemsSchema(other.getItemsSchema());
        }
        if (other.getContainsSchema() != null) {
            base.setContainsSchema(other.getContainsSchema());
        }
        if (other.getItemsSchemaList() != null) {
            base.setItemsSchemaList(mergeLists(base.getItemsSchemaList(), other.getItemsSchemaList()));
        }
        if (other.getMaxItems() != null) {
            base.setMaxItems(other.getMaxItems());
        }
        if (other.getMinItems() != null) {
            base.setMinItems(other.getMinItems());
        }
        if (other.getMaxProperties() != null) {
            base.setMaxProperties(other.getMaxProperties());
        }
        if (other.getMinProperties() != null) {
            base.setMinProperties(other.getMinProperties());
        }
        if (other.getEnum() != null) {
            base.setEnum(other.getEnum());
        }
        if (other.getNot() != null) {
            base.setNot(other.getNot());
        }
        if (other.getLanguageInjection() != null) {
            base.setLanguageInjection(other.getLanguageInjection());
        }
        if (other.getMetadata() != null) {
            base.setMetadata(other.getMetadata());
        }
        ...
        if (mergedExclusionAndType != null) {
            base.setType(mergedExclusionAndType.type);
        }
        ...
        if (exclusionAndTypesInfo.types != null) {
            base.setTypeVariants(exclusionAndTypesInfo.types);
        }
        if (exclusionAndTypesInfo.isValidByExclusion != null) {
            base.setValidByExclusion(exclusionAndTypesInfo.isValidByExclusion);
        }
