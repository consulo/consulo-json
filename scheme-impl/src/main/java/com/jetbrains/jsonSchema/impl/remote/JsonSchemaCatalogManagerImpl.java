...
public final class JsonSchemaCatalogManagerImpl implements JsonSchemaCatalogManager {
  private static final Logger LOG = Logger.getInstance(JsonSchemaCatalogManagerImpl.class);
  ...
  public JsonSchemaCatalogManagerImpl(@Nonnull Project project) {
    myProject = project;
