...
public final class JsonSchemaCacheManager implements Disposable {
    ...
    private final ConcurrentMap<VirtualFile, CachedValue<JsonSchemaObjectFuture>> cache =
    ...
    public JsonSchemaObject computeSchemaObject(@Nonnull VirtualFile schemaVirtualFile, @Nonnull PsiFile schemaPsiFile) {
        ...
        JsonSchemaObjectFuture newFuture = new CompletableFuture<>();
        CachedValue<JsonSchemaObjectFuture> cachedValue = getUpToDateFuture(schemaVirtualFile, schemaPsiFile, newFuture);
        JsonSchemaObjectFuture cachedFuture = cachedValue.value;
    ...
    @Nonnull
    private CachedValue<JsonSchemaObjectFuture> getUpToDateFuture(@Nonnull VirtualFile schemaVirtualFile,
                                                                  @Nonnull PsiFile schemaPsiFile,
                                                                  @Nonnull JsonSchemaObjectFuture newFuture) {
    ...
    private void completeSync(@Nonnull VirtualFile schemaVirtualFile, @Nonnull PsiFile schemaPsiFile, @Nonnull JsonSchemaObjectFuture future) {
        try {
