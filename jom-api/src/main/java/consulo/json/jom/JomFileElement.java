...
public class JomFileElement<T extends JomElement> {
    ...
    private final JsonFile myPsiFile;
    private final Supplier<T> myRootValue;

    public JomFileElement(JsonFile psiFile, JomFileDescriptor<T> fileDescriptor) {
        myPsiFile = psiFile;
        ...
        myRootValue = LazyValue.notNull(() -> (T)JomProxyInvocationHandler.createProxy(
            ...
            PsiTreeUtil.findChildOfType(myPsiFile, JsonObject.class)
        ));
    }
